...
class Filter extends Component {
  ...
  render() {
    ...
    const { menuName, menuLevel } = filter
    ...
    return (
      <Row gutter={24}>
        <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
          {getFieldDecorator('menuName', { initialValue: menuName || null })(
            <Search
        ...
        <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
          {getFieldDecorator('menuLevel', { initialValue: menuLevel })(
            <Select
              style={{ width: 200 }}
              onChange={this.handleChangeMenuLevel}
              placeholder={i18n.t`MenuLevel`}
              allowClear
            >
              <Option value="FRONTEND">
                <Trans>MenuFront</Trans>
              </Option>
              <Option value="BACKEND">
                <Trans>MenuBack</Trans>
              </Option>
            </Select>
          )}
        </Col>
